...
public:
    ...
    explicit PATBoostedTauIDEmbedder(const edm::ParameterSet&);
...
PATBoostedTauIDEmbedder::PATBoostedTauIDEmbedder(const edm::ParameterSet& cfg)
{
...
DEFINE_FWK_MODULE(PATBoostedTauIDEmbedder);
